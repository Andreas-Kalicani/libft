...
#    Updated: 2023/10/17 13:53:27 by akalican         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putstr_fd.c ft_split.c ft_strchr.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strmapi.c \
ft_strncmp.c ft_strndup.c ft_strnstrn.c ft_strrchr.c  ft_strtrim.c ft_substr.c \
ft_tolower.c ft_toupper.c \

BONUS=ft_lstdelone.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c
